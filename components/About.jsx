...
function About() {
  return (
    <div className="h-screen mx-[27px] flex flex-col justify-center items-center pt-18 overflow-hidden md:h-4/5 xl:h-[600px] xl:flex xl:flex-row-reverse xl:px-[150px]">
